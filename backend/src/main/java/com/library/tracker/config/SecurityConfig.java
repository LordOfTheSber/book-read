    ...
    public SecurityFilterChain securityFilterChain( HttpSecurity http ) throws Exception {
        http.csrf( csrf -> csrf.disable() )
            .authorizeHttpRequests( auth -> auth
                        ...
                        .requestMatchers( "/api/v1/users/me" ).hasAnyRole( "SUPER_ADMIN", "ADMIN", "EDITOR", "USER" )
                        ...
                        .requestMatchers( HttpMethod.POST, "/api/v1/items" ).hasAnyRole( "SUPER_ADMIN", "ADMIN", "EDITOR", "USER" )
                        ...
                        .requestMatchers( "/api/v1/sessions/**" ).hasAnyRole( "SUPER_ADMIN", "ADMIN" )
