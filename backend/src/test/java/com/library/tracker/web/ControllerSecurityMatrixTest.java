...
class ControllerSecurityMatrixTest {
    ...
    private static Stream<Endpoint> endpoints() {
        ...
        return Stream.of(
                ...
                Endpoint.post( "/api/v1/tags/" + ID + "/merge", "{\"sourceId\":\"" + ID + "\"}",
                               SUPER_ADMIN, ADMIN, EDITOR, USER ),
                ...
                Endpoint.get( "/api/v1/authors/showcase?ids=" + ID, SUPER_ADMIN, ADMIN, EDITOR, USER ),
                Endpoint.post( "/api/v1/authors/" + ID + "/merge", "{\"sourceId\":\"" + ID + "\"}",
                               SUPER_ADMIN, ADMIN ),
                ...
                Endpoint.get( "/api/v1/series/showcase?ids=" + ID, SUPER_ADMIN, ADMIN, EDITOR, USER ),
