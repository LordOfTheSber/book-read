...
CONTEXT = [
    ...
    # у текста порог 4.5:1, поэтому акцент-текст темнее акцента-заливки
    ('color: #2563eb', 'color: #B04B29'),
...
COLORS = [
    # затемнённые под контраст варианты прежней палитры
    ('#378311', '#3A7657'), ('#2F850B', '#2F6147'), ('#B05907', '#94641C'), ('#A75E0F', '#8E6721'),
    ('#1368DE', '#2E4472'), ('#CA2881', '#A44B72'), ('#0C7E7E', '#2C776E'), ('#077F83', '#2C776E'),
    ('#C54216', '#AB5128'), ('#CE360D', '#AB5128'), ('#986A0C', '#8E6721'), ('#9F6604', '#8E6721'),
    ('#C93D3E', '#8A2323'), ('#1e40af', '#122038'), ('#a8071a', '#7A1F1F'), ('#73d13d', '#7FB08F'),
    ('#85a5ff', '#E8C9BC'), ('#1f2430', '#141C2E'),
    # каркас
    ...
    ('rgba(0,0,0,0.65)', 'rgba(23,32,46,0.78)'), ('rgba(0,0,0,0.55)', 'rgba(23,32,46,0.62)'),
    ('rgba(0,0,0,0.45)', 'rgba(23,32,46,0.62)'), ('rgba(0,0,0,0.42)', 'rgba(23,32,46,0.50)'),
    ('rgba(0,0,0,0.25)', 'rgba(23,32,46,0.50)'), ('rgba(0,0,0,0.20)', 'rgba(23,32,46,0.22)'),
...
def restyle(src: str) -> str:
    ...
    out = out.replace("    a { color: #2563eb;", "    a { color: #B04B29;")
